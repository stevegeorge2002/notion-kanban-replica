"""Simplified Notion Kanban - FastAPI + HTML/JS frontend."""
    ...
    <div class="modal" id="columnModal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button onclick="closeColumnModal()">✕</button>
            </div>
    ...
    <script>
                ...
                columnEl.innerHTML = `
                    <div class="column-header">
                        ...
                        <div class="column-actions">
                            <button onclick="openCardModal(${col.id})">+</button>
        ...
        function getCardsForColumn(columnId) {
            ...
            if (columnCards.length === 0) {
                return '<p class="empty-state">Drop cards here</p>';
            }
